...
import { INJECTION_DEFAULTS, buildInjection, latestUserText, recallHits, renderRecall, userTextFromEvents } from './inject.js';
...
export function apply(ctx, config) {
  ...
  //                         dsh-memory-evolve's onSettled(agent, turn, reason)
